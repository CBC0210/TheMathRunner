...
class HowToPlayScreen extends Scene {
  ...
  void display() {
    ...
    app.textSize(24);
    app.fill(255);
    app.text("玩法説明", app.width / 2, 50);
    
    app.textSize(16);
    app.text("1. 控制你的軍隊，選擇合適的選項來增加軍隊人數。", app.width / 2, 150);
    app.text("2. 與敵人對抗，確保至少有一人能到達終點。", app.width / 2, 200);
    app.text("3. 根據提示進行選擇，完成每個關卡的挑戰。", app.width / 2, 250);
